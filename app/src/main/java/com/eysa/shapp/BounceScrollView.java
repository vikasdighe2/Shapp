...
public class BounceScrollView extends ScrollView
{
    ...
    public BounceScrollView(final Context context) {
        super(context);
        init();
    }

    public BounceScrollView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init();
    }


    public BounceScrollView(final Context context, final AttributeSet attrs, final int defStyleAttr) {
