package com.eysa.shapp.tindercard;
...
import com.eysa.shapp.DiscoverFragment;
...
public class FlingCardListener implements View.OnTouchListener {
    ...
    public boolean onTouch(View view, MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                DiscoverFragment.removeBackground();
    ...
    private boolean resetCardViewOnStack() {
        if (movedBeyondLeftBorder()) {
            // Left Swipe
            onSelected(true, getExitPoint(-objectW), 100, false);
            mFlingListener.onScroll(-1.0f);
        } else if (movedBeyondRightBorder()) {
            // Right Swipe
            onSelected(false, getExitPoint(parentWidth), 100, false);
            mFlingListener.onScroll(1.0f);
        } else if(moveBeyondDown()){
            onSelected(false, getExitPoint(parentWidth), 100, true);
            mFlingListener.onScroll(1.0f);
        }
        else {
    ...
    private boolean moveBeyondDown(){
        return aPosY + halfHeight > downBorder();
    }
    ...
    public void onSelected(final boolean isLeft,
                           float exitY, long duration, final boolean isDown) {
                ...
                .setListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        if (isLeft) {
                            ...
                            mFlingListener.onCardExited();
                            mFlingListener.downExit(dataObject);
                        }
                        else {
                            mFlingListener.onCardExited();
    ...
    *//**
    ...
    protected interface FlingListener {
        ...
        void downExit (Object dataObject);
