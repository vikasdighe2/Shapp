...
public class AddProductActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageLoader = new ImageLoader(getApplicationContext(), AddProductActivity.this);
        ...
        product_info_block = (LinearLayout) this.findViewById(R.id.product_info_block);
        ...
        if (extras != null) {
            ...
            image5 = extras.getString("image5");
            vidio = extras.getString("vidio");
        }

        product_info_close_image = (ImageView) this.findViewById(R.id.product_info_close_image);
        info_block_next_image = (ImageView) this.findViewById(R.id.info_block_next_image);
        addProduct = (Button) this.findViewById(R.id.add_product);

        havebill_switch = (Switch) this.findViewById(R.id.havebill_switch);
        product_name_text = (EditText) this.findViewById(R.id.product_name_text);
        product_details_text = (EditText) this.findViewById(R.id.product_details_text);
        min_bit_amount_text = (EditText) this.findViewById(R.id.min_bit_amount_text);
        buynow_amount_text = (EditText) this.findViewById(R.id.buynow_amount_text);

        start_time_text = (EditText) this.findViewById(R.id.start_time_text);
        start_datepicker = (DatePicker) this.findViewById(R.id.start_datepicker);
        start_timepicker = (TimePicker) this.findViewById(R.id.start_timepicker);

        end_time_text = (EditText) this.findViewById(R.id.end_time_text);
        end_datepicker = (DatePicker) this.findViewById(R.id.end_datepicker);
        end_timepicker = (TimePicker) this.findViewById(R.id.end_timepicker);

        quality_text = (EditText) this.findViewById(R.id.quality_text);
        quality_dropview = (LinearLayout) this.findViewById(R.id.quality_dropview);

        category_text = (EditText) this.findViewById(R.id.category_text);
        category_dropview = (LinearLayout) this.findViewById(R.id.category_dropview);

        brand_text = (EditText) this.findViewById(R.id.brand_text);
        brand_dropview = (LinearLayout) this.findViewById(R.id.brand_dropview);

        model_text = (EditText) this.findViewById(R.id.model_text);
        group_text = (EditText) this.findViewById(R.id.group_text);
        model_dropview = (LinearLayout) this.findViewById(R.id.model_dropview);
        group_dropview = (LinearLayout) this.findViewById(R.id.group_dropview);

        info_block_scroll_view = (BounceScrollView) this.findViewById(R.id.info_block_scroll_view);
    ...
    public void save_product(){
        ...
        ParameterMap httpClientUserDataParameters = httpClientUserData.newParams()
                ...
                .add("quality_id", selected_quality_id)
